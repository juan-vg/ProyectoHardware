...
resultados:
     /* 6 huecos para almacenar resultados de celdas vacias
         + 2 huecos para almacenar resultados de la comprobacion + PADDING */
    .hword 0,0,0,0,0,0,0xFFFF,0xFFFF,0,0,0,0,0,0,0,0
