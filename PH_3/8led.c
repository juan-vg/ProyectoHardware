...
void D8Led_siguiente(void) {
	...
	// avanzar el 8Led solo si esta permitido que se haga (avance activado)
	if (avance == 1) {
...
/**
 * Permite modificar el valor del 8Led
 */
void D8Led_activar_avance(void) {
	avance = 1;
}
...
/**
 * Impide modificar el valor del 8Led
 */
void D8Led_desactivar_avance(void) {
	avance = 0;
}
